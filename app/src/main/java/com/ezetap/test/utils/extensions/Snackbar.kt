...
import com.ezetap.test.databinding.LayoutSnackbarDefaultBinding
...
/**
 * Extension function to customise Snackbar layout for Repos
 */
fun Snackbar.customiseForEzetap(
    text: String,
